 ...
 */
function baizonn_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
...
add_filter( 'wp_calculate_image_sizes', 'baizonn_content_image_sizes_attr', 10, 2 );
 ...
 */
function baizonn_header_image_tag( $html, $header, $attr ) {
	if ( isset( $attr['sizes'] ) ) {
		$html = str_replace( $attr['sizes'], '100vw', $html );
	}
	return $html;
}
add_filter( 'get_header_image_tag', 'baizonn_header_image_tag', 10, 3 );
 ...
 */
function baizonn_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'baizonn_post_thumbnail_sizes_attr', 10, 3 );